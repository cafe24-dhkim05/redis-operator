...
Development of redis docker image is maintained inside a different repository - https://github.com/cafe24-dhkim05/redis. To make any change or suggestion related to Redis docker image, please refer to this repository and make required changes.

In the repository, we have `Dockerfile` for [Redis](https://github.com/cafe24-dhkim05/redis/blob/master/Dockerfile) and [Redis Exporter](https://github.com/cafe24-dhkim05/redis/blob/master/Dockerfile.exporter)
